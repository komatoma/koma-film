...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "კინოს ბიბლიოთეკა — იპოვე შენი შემდეგი ფილმი" },
      {
        name: "description",
        content:
          "მოძებნე ფილმები სახელით ან თემით, ნახე დეტალები და ტრეილერები. თანამედროვე, მუქი დიზაინის კინო ბიბლიოთეკა.",
      },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "კინოს ბიბლიოთეკა — იპოვე შენი შემდეგი ფილმი" },
      {
        property: "og:description",
        content: "მოძებნე ფილმები სახელით ან თემით, ნახე დეტალები და ტრეილერები.",
      },
